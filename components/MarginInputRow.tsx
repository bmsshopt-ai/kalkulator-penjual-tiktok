    ...
    <div className="grid grid-cols-2 items-center gap-4 py-2.5 border-b border-slate-100 last:border-b-0">
      ...
      <div className="flex items-center justify-end gap-4">
        {calculatedValue !== undefined && !isNaN(calculatedValue) && (
          <span className="text-sm font-mono bg-slate-200 text-slate-800 px-2 py-1 rounded-md hidden md:inline-block">
            = {mode === 'percent' ? formatCurrency(calculatedValue) : formatPercentage(calculatedValue)}
          </span>
        )}
